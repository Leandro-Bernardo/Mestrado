...
class Bisulfite2DNetwork(ContinuousNetwork):
...
class Bisulfite2DUpNetwork(ContinuousUpNetwork):
    def __init__(self, backbone: Module, **kwargs: Any) -> None:
        super().__init__(**kwargs)
        self.model = torch.nn.Sequential(OrderedDict([
            ("backbone", backbone),
...
class Bisulfite2DNetworkMobileNetV3Style(Bisulfite2DNetwork):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(backbone=MobileNetV3Small(in_channels=1, num_classes=1), **kwargs)


class Bisulfite2DNetworkSqueezeNetStyle(Bisulfite2DNetwork):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(backbone=SqueezeNet1_1(in_channels=1, num_classes=1), **kwargs)


class Bisulfite2DNetworkVgg11Style(Bisulfite2DNetwork):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(backbone=Vgg11(in_channels=1, num_classes=1), **kwargs)


class Bisulfite2DIntervalNetwork(IntervalNetwork):
    def __init__(self, backbone: Module, **kwargs: Any) -> None:
        super().__init__(**kwargs)
        self.model = torch.nn.Sequential(OrderedDict([
            ("pre_processing", PreProcessing(**kwargs)),
...
class Bisulfite2DIntervalNetworkSqueezeNetStyle(Bisulfite2DIntervalNetwork):
...
class Bisulfite2DNetworkUpVgg11Style(Bisulfite2DUpNetwork):
...
class Bisulfite2DEstimationFunction(EstimationFunction):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(Bisulfite2DNetwork, **kwargs)
