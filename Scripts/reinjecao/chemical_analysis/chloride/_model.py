...
class ChlorideNetwork(ContinuousNetwork):
...
class ChlorideNetworkSqueezeNetStyle(ChlorideNetwork):
    def __init__(self, **kwargs: Any) -> None:
...
class ChlorideIntervalNetworkSqueezeNetStyle(ChlorideIntervalNetwork):
...
class ChlorideEstimationFunction(EstimationFunction):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(ChlorideNetwork, **kwargs)
