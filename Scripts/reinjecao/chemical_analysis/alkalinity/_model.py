...
class AlkalinityUpNetwork(ContinuousUpNetwork):
    def __init__(self, backbone: Module, **kwargs: Any) -> None:
        super().__init__(**kwargs)
        self.model = torch.nn.Sequential(OrderedDict([
            ("backbone", backbone),
...
class AlkalinityNetworkShuffleNetV2X10Style(AlkalinityNetwork):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(backbone=ShuffleNetV2X10(in_channels=1, num_classes=1), **kwargs)


class AlkalinityNetworkShuffleNetV2X15Style(AlkalinityNetwork):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(backbone=ShuffleNetV2X15(in_channels=1, num_classes=1), **kwargs)


class AlkalinityNetworkShuffleNetV2X20Style(AlkalinityNetwork):
    def __init__(self, **kwargs: Any) -> None:
...
class AlkalinityNetworkUpVgg11Style(AlkalinityUpNetwork):
...
class AlkalinityEstimationFunction(EstimationFunction):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(AlkalinityNetwork, **kwargs)
