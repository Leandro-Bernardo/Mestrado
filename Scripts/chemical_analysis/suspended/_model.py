...
class SuspendedNetwork(ContinuousNetwork):
...
class SuspendedIntervalNetworkSqueezeNetStyle(SuspendedIntervalNetwork):
...
class SuspendedEstimationFunction(EstimationFunction):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(SuspendedNetwork, **kwargs)
